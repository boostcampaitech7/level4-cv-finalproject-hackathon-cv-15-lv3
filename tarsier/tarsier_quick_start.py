...
def run():
    ...
    parser.add_argument('--model_name_or_path', type=str, default="../../Tarsier-7b")
    parser.add_argument('--instruction', type=str, default="Describe the video in detail.", help='Input prompt.')
    parser.add_argument('--input_path', type=str, default="../dataset/videos/clip_026.mp4", help='Path to video/image; or Dir to videos/images')
